...
|TOK_MENOS exp %prec MU {fprintf(yyout,";R76:\t<exp> ::= - <exp>\n");}
...
/* printf("    ****Error sintactico en [lin %d, col %d]: simbolo %s no permitido!!\n",linea,columna,yytext); */
}
flag=0;
return -1;
}
